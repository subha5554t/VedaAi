    ...
    <div className="flex flex-col flex-1 min-h-screen lg:min-h-0 pb-16 lg:pb-0">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {isProcessing && (
          <div className="flex-1 flex flex-col items-center justify-center px-4 py-16">
            <div className="text-center max-w-sm">
              ...
              <h2 className="text-[17px] font-semibold text-gray-900">Generating Question Paper</h2>
              ...
              <p className="mt-3 text-[11px] text-gray-400">"{currentAssignment.title}"</p>
            </div>
          </div>
        )}
        ...
        {currentAssignment.status === 'failed' && (
          <div className="flex-1 flex flex-col items-center justify-center px-4 py-16">
            <div className="text-center max-w-sm">
              ...
              <h2 className="text-[17px] font-semibold text-gray-900">Generation Failed</h2>
        ...
        {currentAssignment.status === 'completed' && currentAssignment.result && (
          <QuestionPaperView
            paper={currentAssignment.result}
